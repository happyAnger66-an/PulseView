...
mw::proto::NodeThreadInfo *ThreadMonitor::AddCpuTime(
    pid_t pid, pid_t tid, int type, mw::proto::SystemStats &msg) {
  ...
  mw::proto::NodeThreadInfo *one_thread_msg = nullptr;
...
int32_t ThreadMonitor::RunOnce(mw::proto::SystemStats &msg) {
